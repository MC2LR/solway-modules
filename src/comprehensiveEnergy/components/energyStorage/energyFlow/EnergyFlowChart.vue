<template>
    <div class="energy-flow-chart clearfix" :class="color">
        <i class="iconfont icondianchi-" :class="'s' + useStatus"></i>
        <i class="iconfont iconbianyaqikong-"></i>
        <i class="iconfont iconbianyaqidian-" :class="{shan: remain && (useStatus !== '03')}"></i>
