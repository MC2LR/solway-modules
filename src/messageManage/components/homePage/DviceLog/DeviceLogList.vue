                ...
                <el-form
                    ...
                    <el-form-item
                        ...
                        <el-popover
                            ...
                            <el-input @input="popover_text = popoverText" v-model="popover_text" slot="reference"></el-input>
                        </el-popover>
                    </el-form-item>
                    ...
                    <el-form-item
                        ...
                        <el-select
                            ...
                            multiple
                            collapse-tags
                            @change="deviceLogNewDeviceLogListByPageAndStartTime.getData()"
...
export default {
    ...
    methods: {
        ...
        deviceChange (text, data) {
            ...
            // if (!this.deviceLogNewDeviceLogListByPageAndStartTime.res.body.data[0]) {
            // }
        },
        updateSuccess () {
