    ...
    <div>
        ...
        <div class="lately">
            ...
            <span
                ...
                @click="() => changeStation({treeId: item.currentTreeId, stClass: item.currentClass, dataType: item.currentBusiType})">
...
export default {
    ...
    computed: {
        ...
        recentlyStation () {
            let recently = this.$store.getters.station_recently(this.types).filter(v => v.currentClass === this.stClass)
            const obj = {}
