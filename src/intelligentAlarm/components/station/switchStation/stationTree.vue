    ...
    <div>
        <div class="lately">
            ...
            <span
                ...
                @click="() => changeStation({treeId: item.currentTreeId, stClass, dataType: item.currentBusiType})">
...
export default {
    ...
    computed: {
        tree () {
            return this.$store.state.station.stationTree[this.stClass]
        },
        hasStation () {
