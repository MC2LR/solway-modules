        ...
        <div class="content">
            <div class="content-middle">
                <div class="item font12 orange">
                    <p>节省标煤</p>
                    <div class="circle-con"><img src="./images/circle-orange.png" class="rotate-img-left"><i class="comprehensive iconmei1"></i></div>
                    <p><span class="font18">{{data.coal}}</span><span>{{units.coal}}</span></p>
                </div>
                <div class="item font12 blue">
                    <p>CO2减排</p>
                    <div class="circle-con"><img src="./images/circle-blue.png" class="rotate-img-left"><i class="comprehensive iconCO-"></i></div>
                    <p><span class="font18">{{data.co2}}</span><span>{{units.co2}}</span></p>
                </div>
                <div class="item font12 green">
                    <p>植树</p>
                    <div class="circle-con"><img src="./images/circle-green.png" class="rotate-img"><i class="comprehensive iconshu"></i></div>
