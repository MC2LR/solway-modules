                ...
                <div class="filter">
                    <el-form ref="Form" :inline='true' size="small">
                        <el-form-item label="">
                            ...
                            placeholder="请输入分组名称"
                            @keydown.enter.native="getGroupList()"
                            @input="getGroupList()"
                            >
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <span v-show="!scope.row.edit" style="display: inline-block;width: 147px;padding-left: 15px;color: #606266;">{{scope.row.groupName}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="longitude"
                        ...
                        <template slot-scope="scope">
                            ...
                            <span v-show="!scope.row.edit" style="display: inline-block;width: 147px;padding-left: 15px;color: #606266;">{{scope.row.longitude}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="latitude"
                        label="纬度">
                        <template slot-scope="scope">
                            <el-input type="number" v-if="scope.row.edit === true" size="small" v-model="scope.row.latitude" placeholder="请输入分组名称" title=""></el-input>
                            <span v-if="!scope.row.edit === true" style="display: inline-block;width: 147px;padding-left: 15px;color: #606266;">{{scope.row.latitude}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="position"
...
<script>
import { api＿deviceGroupList, api＿deviceGroupUpdate, api＿deviceGroupDelete, api＿deviceGroupListBind, api＿deviceGroupListUnbind, api＿deviceGroupDoBind } from '@newEnergyCloud/request/api'
