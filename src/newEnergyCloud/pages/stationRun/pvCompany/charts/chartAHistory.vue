<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            v-loading='pvMonitorGetKWLine.loading'
            ref="chart"
        ></ve-histogram>
    </div>
</template>
...
import { api＿pvMonitorGetKWLine } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            pvMonitorGetKWLine: api＿pvMonitorGetKWLine({
                later: true
            }),
            chartData: {
    ...
    methods: {
        ...
        getChartData () {
            this.pvMonitorGetKWLine.getData({
                    queryType: 1,
                    dateType: 3,
                    date: this.showTime
                }).then(res => {
