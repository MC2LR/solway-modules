<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryPvMonthElecTimelistV201.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryPvMonthElecTimelistV201 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            queryPvMonthElecTimelistV201: api＿queryPvMonthElecTimelistV201({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            this.queryPvMonthElecTimelistV201.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
