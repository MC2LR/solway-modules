    ...
    <div class="child-head">
        ...
        <div class="right pull-right">
            <div class="item pull-left">
                <div class="value"><span>{{pvMonitorRunBaseInfo.res.body.powerStationNum || '-'}}</span>个</div>
...
<script>
import { api＿pvMonitorRunBaseInfo } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            pvMonitorRunBaseInfo: api＿pvMonitorRunBaseInfo({
                later: true,
                res: {
                    body: {
                    }
    ...
    methods: {
        ...
        getStationNum () {
            this.pvMonitorRunBaseInfo.getData({date: this.dateFormatter})
        }
    },
    beforeDestroy () {
