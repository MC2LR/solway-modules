<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpYearElecTimelistV202.loading'
        ></ve-histogram>
        <el-select
        v-model="legendIndex"
        class="legendChange"
...
import { api＿queryWpYearElecTimelistV202 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            chartExtend: {},
            queryWpYearElecTimelistV202: api＿queryWpYearElecTimelistV202({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        changeLegend () {
            this.chartData.rows = []
            const { data } = this.queryWpYearElecTimelistV202.res.body
        ...
        getChartData () {
            this.queryWpYearElecTimelistV202.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
