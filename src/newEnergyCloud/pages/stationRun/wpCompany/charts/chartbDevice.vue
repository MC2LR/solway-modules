<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='(wpMonitorGetRtKWHList.resNumber === 0) && wpMonitorGetRtKWHList.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿wpMonitorGetRtKWHList } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            wpMonitorGetRtKWHList: api＿wpMonitorGetRtKWHList({
                later: true,
                sameTimeOnce: true,
                res: {
                    body: {
    ...
    methods: {
        ...
        getChartData () {
            try {
                this.wpMonitorGetRtKWHList.getData({
                        queryType: 1,
                        date: this.showTime
                    }).then(res => {
                        this.chartData.rows = []
