<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpMonthElecTimelistV202.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpMonthElecTimelistV202 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            queryWpMonthElecTimelistV202: api＿queryWpMonthElecTimelistV202({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            this.queryWpMonthElecTimelistV202.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
