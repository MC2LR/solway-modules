<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpMonthElecCompanyStationlistV202.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpMonthElecCompanyStationlistV202 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            queryWpMonthElecCompanyStationlistV202: api＿queryWpMonthElecCompanyStationlistV202({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            this.queryWpMonthElecCompanyStationlistV202.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
