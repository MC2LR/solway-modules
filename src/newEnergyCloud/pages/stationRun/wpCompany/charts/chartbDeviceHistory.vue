<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpDayElecCompanyStationlistV202.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpDayElecCompanyStationlistV202 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            queryWpDayElecCompanyStationlistV202: api＿queryWpDayElecCompanyStationlistV202({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            this.queryWpDayElecCompanyStationlistV202.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
