<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='comLineGetStRkLineMonth.loading'
        ></ve-histogram>
        <el-select
        v-model="legendIndex"
        class="legendChange"
...
import { api＿comLineGetStRkLineMonth } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            chartExtend: {},
            comLineGetStRkLineMonth: api＿comLineGetStRkLineMonth({
                later: true,
                res: {
                    body: {
                        data: {
    ...
    methods: {
        ...
        changeLegend () {
            const { data } = this.comLineGetStRkLineMonth.res.body
            let arr1 = []
            let arr2 = []
            let arr3 = []
            let arr4 = []
        ...
        getChartData () {
            ...
            this.comLineGetStRkLineMonth.getData({
                    stcls: '01',
                    date: this.showTime
                }).then(res => {
