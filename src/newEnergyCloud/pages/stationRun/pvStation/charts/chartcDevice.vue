<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='comLineGetStDeviceRkLineMonth.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿comLineGetStDeviceRkLineMonth } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            comLineGetStDeviceRkLineMonth: api＿comLineGetStDeviceRkLineMonth({
                later: true,
                res: {
                    body: {
                        data: {
    ...
    methods: {
        ...
        getChartData () {
            ...
            this.comLineGetStDeviceRkLineMonth.getData({
                    stcls: '01',
                    date: this.showTime
                }).then(res => {
