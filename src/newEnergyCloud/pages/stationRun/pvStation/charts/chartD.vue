<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='comLineGetStRkLineYear.loading'
        ></ve-histogram>
        <el-select
        v-model="legendIndex"
        class="legendChange"
...
import { api＿comLineGetStRkLineYear } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            chartExtend: {},
            comLineGetStRkLineYear: api＿comLineGetStRkLineYear({
                later: true,
                res: {
                    body: {
                        data: {
    ...
    methods: {
        ...
        changeLegend () {
            const { data } = this.comLineGetStRkLineYear.res.body
            let arr1 = []
            let arr2 = []
            let arr3 = []
            this.chartData.rows = []
        ...
        getChartData () {
            ...
            this.comLineGetStRkLineYear.getData({
                    stcls: '01',
                    date: this.showTime
                }).then(res => {
