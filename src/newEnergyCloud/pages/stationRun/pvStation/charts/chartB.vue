<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='comLineGetStRkLineDay.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿comLineGetStRkLineDay } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            comLineGetStRkLineDay: api＿comLineGetStRkLineDay({
                later: true,
                res: {
                    body: {
                        data: {
    ...
    methods: {
        ...
        getChartData () {
            ...
            this.comLineGetStRkLineDay.getData({
                    stcls: '01',
                    date: this.showTime
                }).then(res => {
