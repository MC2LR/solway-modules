<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='comLineGetStDeviceRkLineYear.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿comLineGetStDeviceRkLineYear } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            comLineGetStDeviceRkLineYear: api＿comLineGetStDeviceRkLineYear({
                later: true,
                res: {
                    body: {
                        data: {
    ...
    methods: {
        ...
        getChartData () {
            ...
            this.comLineGetStDeviceRkLineYear.getData({
                    stcls: '01',
                    date: this.showTime
                }).then(res => {
