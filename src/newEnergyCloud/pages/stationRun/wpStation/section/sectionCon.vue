<template>
    <div class="child-section clearfix">
        <div class="section" :class="{'stShadow': sectionShadow === 0}" @click="changeChart(0)">
            ...
            smallDataName='实时风速'
            :smallDataValue='pvwpStationRtOverviewDay.res.body.day.data.ws'
            :smallDataUnit='pvwpStationRtOverviewDay.res.body.day.units.ws || "-"'>
            ...
            smallDataName='平均风速'
            :smallDataValue='pvwpStationRtOverviewDay.res.body.day.data.ws_avg1'
            smallDataUnit='m/s'>
                <template v-slot:default>
                    <div class="right1">
                        <!-- <div class="temp-con">
        ...
        <div class="section" :class="{'stShadow': sectionShadow === 1}" @click="changeChart(1)">
            ...
            liquidName='计划完成'
            bigDataName='日发电量'
            :bigDataValue='pvwpStationRtOverviewDay.res.body.day.data.real_kwh'
            :bigDataUnit='pvwpStationRtOverviewDay.res.body.day.units.real_kwh || "-"'
            smallDataName='日发电小时数'
            :smallDataValue='pvwpStationRtOverviewDay.res.body.day.data.real_hours'
            :smallDataUnit='pvwpStationRtOverviewDay.res.body.day.units.real_hours || "-"'>
                <template v-slot:default>
        ...
        <div class="section" :class="{'stShadow': sectionShadow === 2}" @click="changeChart(2)">
            ...
            liquidName='计划完成'
            bigDataName='月累计发电量'
            :bigDataValue='pvwpStationRtOverviewDay.res.body.month.data.real_kwh'
            :bigDataUnit='pvwpStationRtOverviewDay.res.body.month.units.real_kwh || "-"'
        ...
        <div class="section" :class="{'stShadow': sectionShadow === 3}" @click="changeChart(3)">
            ...
            liquidName='计划完成'
            bigDataName='年累计发电量'
            :bigDataValue='pvwpStationRtOverviewDay.res.body.year.data.real_kwh'
            :bigDataUnit='pvwpStationRtOverviewDay.res.body.year.units.real_kwh || "-"'
