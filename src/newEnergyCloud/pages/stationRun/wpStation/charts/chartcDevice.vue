<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpMonthElecStationDevlistV201.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpMonthElecStationDevlistV201 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            queryWpMonthElecStationDevlistV201: api＿queryWpMonthElecStationDevlistV201({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            ...
            this.queryWpMonthElecStationDevlistV201.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
