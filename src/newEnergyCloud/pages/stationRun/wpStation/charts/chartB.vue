<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpMonthElecTimelistV201.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpMonthElecTimelistV201 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            queryWpMonthElecTimelistV201: api＿queryWpMonthElecTimelistV201({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        resizeChart (i) {
            ...
            if (this.showChartIndex !== 1 || this.tabIndex !== 0) return
            setTimeout(() => {
                this.getChartData()
        ...
        getChartData () {
            ...
            this.queryWpMonthElecTimelistV201.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
