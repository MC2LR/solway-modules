<template>
    <div class="wrap">
        <ve-histogram
            ...
            height='100%'
            ref='chart'
            v-loading='queryWpYearElecStationDevlistV201.loading'
        ></ve-histogram>
    </div>
</template>
...
import { api＿queryWpYearElecStationDevlistV201 } from '@newEnergyCloud/request/api'
...
export default {
    ...
    data () {
        return {
            ...
            showChartIndex: 0,
            pageTheme: '',
            queryWpYearElecStationDevlistV201: api＿queryWpYearElecStationDevlistV201({
                later: true,
                res: {
                    body: {
                        data: [],
    ...
    methods: {
        ...
        getChartData () {
            ...
            this.queryWpYearElecStationDevlistV201.getData({
                    date: this.showTime
                }).then(res => {
                    this.chartData.rows = []
