...
export default {
    data () {
        return {
            ...
            chartData: {
                columns: ['时间', '光伏实发功率(kW)', '风电实发功率(kW)'],
                rows: []
            }
        }
    },
    ...
    methods: {
        ...
        getChartData () {
            ...
            try {
                ...
                .then(res => {
                    // 刘小军 看着原来的判断有的难受，改了一下
                    if (!res?.body) return this.setDataNull()
                    // 刘小军 在这里加一行代码，解决曲线重复问题
                    ...
                    if (this.stationDayTodayTimeLineData.line1.length === 0 && this.stationDayTodayTimeLineData.line3.length === 0) {
                        this.stationDayTodayTimeLineData.line1 = new Array(res.body.chart_wp.echarts_xaxisTime.length - res.body.chart_pv.echarts_xaTime.length).fill('-')
                    }
                    ...
                    this.stationDayTodayTimeLineData.line1 = this.stationDayTodayTimeLineData.line1.slice(0, length - 1).concat(res.body.chart_pv.echarts_p)
                    ...
                    this.stationDayTodayTimeLineData.line3 = this.stationDayTodayTimeLineData.line3.slice(0, length - 1).concat(res.body.chart_wp.echarts_power_o)
                    let arr1 = []
                    let arr2 = []
                    // let arr3 = []
                    let arr4 = []
