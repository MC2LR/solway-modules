  ...
  methods: {
    async openPrice () {
      ...
      if (this.detail) {
        ...
        this.custStElecPriceSaveElecPrice.params.stId = this.custStElecPriceSaveElecPrice.params.stid
      } else {
          delete this.custStElecPriceSaveElecPrice.params.id
          this.custStElecPriceSaveElecPrice.params.stId = this.powerDetail.stid
      }
    },
    // 取消
    cancel () {
