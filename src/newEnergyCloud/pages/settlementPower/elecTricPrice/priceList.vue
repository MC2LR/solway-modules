    ...
    <div class="price-list">
        ...
        <div class="tableCon">
            <el-table
                ...
                ></el-table-column>
                <el-table-column prop="sharpOrigPrice" label="尖原电价(元)" sortable="custom" min-width="125"></el-table-column>
                <el-table-column prop="peakOrigPrice" label="峰原电价(元)" sortable="custom" min-width="125"></el-table-column>
                <el-table-column prop="flatOrigPrice" label="平原电价(元)" sortable="custom" min-width="125"></el-table-column>
                <el-table-column prop="valleyOrigPrice" label="谷原电价(元)" sortable="custom" min-width="125"></el-table-column>
...
export default {
    ...
    mounted () {
        this.$bus.on('updatePriceList', this.getList)
    },
    methods: {
        ...
        getList () {
            this.custStElecPriceGetElecPriceList.getData({stId: this.detail.stid})
        },
        // 删除电价
        deletePrice (row) {
    ...
    beforeDestroy () {
        this.$bus.off('updatePriceList', this.getList)
    }
}
</script>
